    ...
    <div>
      <div className="relative mb-4 max-w-sm">
        ...
        <input
          ...
          placeholder={t("admin.research.search")}
          aria-label={t("admin.research.search")}
                ...
                <tr key={item.id} className="transition-colors hover:bg-surface/60">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex justify-end gap-1">
                      {canEdit && (
                        <IconButton title={t("admin.research.edit")} onClick={() => onEdit(item)}>
                          <Pencil size={16} />
                        </IconButton>
                      )}
                      {canDelete && (
                        <IconButton
                          title={t("admin.research.delete")}
                          danger
